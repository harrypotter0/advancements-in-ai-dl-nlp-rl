...
if __name__ == "__main__":
    ...
    # train the NN
    # W, b, avg_cost_func = train_nn_SGD(nn_structure, X_train, y_v_train,iter_num=3000, alpha=0.25, lamb=0.000)
    W, b, avg_cost_func = train_nn_MBGD(nn_structure, X_train, y_v_train,bs=100,iter_num=3000, alpha=0.25, lamb=0.000)
